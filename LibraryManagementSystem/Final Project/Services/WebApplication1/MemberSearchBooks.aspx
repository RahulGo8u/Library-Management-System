<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="MemberSearchBooks.aspx.cs" Inherits="WebApplication1.MemberSearchBooks" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="options" style="width:200px ; float:left">
        ...
        <br/><br/><br/><br/>
        <div class="bookdetails" style="width:auto">
